...
act_maxval_layer_arr_max = [16,2,16,2,16,2,0,8,2]
act_maxval_layer_arr_mid = [8,2,8,2,8,2,0,4,1]
act_maxval_layer_arr_8 = [4,1,4,1,4,1,0,2,0.5]
#act_config_all = [act_maxval_layer_arr_max, act_maxval_layer_arr_mid, act_maxval_layer_arr_8]
act_config_all = [act_maxval_layer_arr_mid, act_maxval_layer_arr_8]
result_holder = []
    ...
    for bw in [8]:
      ...
      class ResNet(nn.Module):
          ...
          def __init__(
              ...
              self.layer1 = self._make_layer(block, 64, layers[0], layer_cnt = layer_cnt)
              layer_cnt = layer_cnt + 4
              self.layer2 = self._make_layer(block, 128, layers[1], stride=2,
                                              dilate=replace_stride_with_dilation[0], layer_cnt = layer_cnt)
              layer_cnt = layer_cnt + 5
              #self.layer3 = self._make_layer(block, 256, layers[2], stride=2,dilate=replace_stride_with_dilation[1], layer_cnt = layer_cnt)
              #layer_cnt = layer_cnt + 5
      ...
      PATH = "/home/shurui/FWNN/fixedpooltraining/fw_weights/resnet10_cifar_zdim64_nofirstlayer.pth"
      ...
      print(inferenceacc)
      SAVEPATH = "/home/shurui/FWNN/fixedpooltraining/fw_weights/resnet10_cifar_zdim64_retrained_"+str(act_prec)+"bit.pth"
      best_prec1 = 0

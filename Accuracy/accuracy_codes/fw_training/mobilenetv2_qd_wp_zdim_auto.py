...
for pool_size in [32]:
    cluster_path = "/home/shurui/FWNN/clustercenters/mobilenetv2_qd_clustercenter_zdim" + str(pool_size) + ".npy"
    ...
    PATH = '/home/shurui/FWNN/fixedpooltraining/weights/mobilenetv2_qd.pth'
    ...
    best_prec1 = 0
    total_time = 0
    SAVEPATH = '/home/shurui/FWNN/fixedpooltraining/mobilenetv2_qd_zdim' + str(pool_size) + '_nofirstlayer.pth'

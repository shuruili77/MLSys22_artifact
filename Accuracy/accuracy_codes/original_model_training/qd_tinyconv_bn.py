# -*- coding: utf-8 -*-
"""qd_Tinyconv_bn.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/160gj3x5HyUmdBEmzsoP8nj_DlX2HfsDK
"""
...
#PATH = '/content/drive/My Drive/data/cifar_tinyconv_bn_82.pth'
#PATH = '/content/drive/My Drive/data/cifar_tinyconv_41conv.pth'
#PATH = '/content/drive/My Drive/data/cifar_tinyconv_bs_full.pth'
...
best_prec1 = 0
#PATH = '/content/drive/My Drive/data/cifar_tinyconv_bn_82.pth'
#PATH = '/content/drive/My Drive/data/cifar_tinyconv_41_full.pth'
PATH = '/content/drive/MyDrive/data/tinyconv_qd_tanh.pth'
#state_dict=torch.load(PATH)
#model.load_state_dict(state_dict)
...
#cluster generation for xy dimension
...
for name, param in state_dict.items():
    if "conv" in name and len(param.shape) == 4:
        ...
        param = param.reshape(orishape[0]*orishape[1], orishape[2]*orishape[3])
        if name == "conv1.weight":#for tinyconv
...
for n_cluster in [32,64,128]:
    ...
    output_path = "/content/drive/MyDrive/FWNN_data/tinyconv_qd_clustercenter_xydim" + str(n_cluster) + ".npy"

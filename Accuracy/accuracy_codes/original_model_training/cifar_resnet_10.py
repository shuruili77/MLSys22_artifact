...
for name, param in state_dict.items():
    if "weight" in name and len(param.shape) == 4:
        ...
        if 'layer' in name and 'conv' in name:
            if name == "layer1.0.conv1.weight":#for resnet
        #if 'features' in name:
            #if name == 'features.0.weight':#for vgg
...
for n_cluster in [32,64,128]:
    ...
    output_path = "/content/drive/MyDrive/FWNN_data/resnet10_cifar_clustercenter_zdim" + str(n_cluster) + ".npy"

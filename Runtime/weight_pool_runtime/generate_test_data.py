...
class TestSettings(ABC):
    ...
    OUTDIR = 'D:/research/fixedweightNN/CMSIS_5-develop/CMSIS_5-develop/TestData/'
...
class ConvSettings(TestSettings):
    ...
    def __init__(self, dataset, testtype, args, in_ch=32, out_ch=32, x_in=32, y_in=32, w_x=3, w_y=3, stride_x=1, stride_y=1,
...
def load_all_testdatasets():
    ...
    ALL_TESTDATA_SETS[dataset] = ConvSettings(dataset, type_of_test, args, in_ch=32, out_ch=32, x_in=32, y_in=32, w_x=3,
    ...
    ALL_TESTDATA_SETS[dataset] = ConvSettings(dataset, type_of_test, args, in_ch=128, out_ch=128, x_in=32, y_in=32, w_x=3,
                                              w_y=3, stride_x=1, stride_y=1, pad=False, randmin=-2, randmax=2,
                                              outminrange=-127, outmaxrange=127, batches=1)
    
    dataset = 'conv_1616_3232'  # batches > 2
    ALL_TESTDATA_SETS[dataset] = ConvSettings(dataset, type_of_test, args, in_ch=32, out_ch=32, x_in=16, y_in=16, w_x=3,
                                              w_y=3, stride_x=1, stride_y=1, pad=False, randmin=-2, randmax=2,
                                              outminrange=-127, outmaxrange=127, batches=1)

    dataset = 'conv_benchmark'  # batches > 2
    ALL_TESTDATA_SETS[dataset] = ConvSettings(dataset, type_of_test, args, in_ch=128, out_ch=128, x_in=16, y_in=16, w_x=3,
                                              w_y=3, stride_x=1, stride_y=1, pad=True, randmin=-2, randmax=2,
                                              outminrange=-127, outmaxrange=127, batches=1)

    dataset = 'conv_small'  # batches > 2
    ALL_TESTDATA_SETS[dataset] = ConvSettings(dataset, type_of_test, args, in_ch=8, out_ch=8, x_in=8, y_in=8, w_x=3,
                                              w_y=3, stride_x=1, stride_y=1, pad=False, randmin=-2, randmax=2,
                                              outminrange=-127, outmaxrange=127, batches=1)
    ...
    ALL_TESTDATA_SETS[dataset] = ConvSettings(dataset, type_of_test, args, in_ch=32, out_ch=32, x_in=4, y_in=4, w_x=3,
    ...
    dataset = 'depthwise_2'
    ALL_TESTDATA_SETS[dataset] = ConvSettings(dataset, type_of_test, args, in_ch=3, out_ch=3, x_in=32, y_in=32, w_x=3,
    ...
    ALL_TESTDATA_SETS[dataset] = FullyConnectedSettings(dataset, type_of_test, args, in_ch=2048, out_ch=10, x_in=1, y_in=1,
                                                        w_x=1, w_y=1, batches=1, input_zero_point=-50,
                                                        output_zero_point=-2)

    dataset = 'fc_full_layer1'
    ALL_TESTDATA_SETS[dataset] = FullyConnectedSettings(dataset, type_of_test, args, in_ch=128, out_ch=10, x_in=1, y_in=1,
                                                        w_x=1, w_y=1, batches=1, input_zero_point=-50,
                                                        output_zero_point=-2)                                                        

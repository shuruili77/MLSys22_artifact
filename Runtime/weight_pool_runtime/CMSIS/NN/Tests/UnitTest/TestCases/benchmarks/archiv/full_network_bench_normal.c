...
void conv_s8_full_network(void)
{
    ...
    static q7_t buffer_1[CONV_FULL_LAYER1_DST_SIZE] = {0};
    static q7_t buffer_2[CONV_FULL_LAYER1_DST_SIZE] = {0};
    ...
    //int flash_copy_status = Flash_Write_Data(0x80010000, buffer_1, n_words_layer); //call the flash copy function to copy activation into flash
    ...
    //All convolution layer finished, the results are stored in buffer_1 (in theory)
}
